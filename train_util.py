...
def open_train_files(train_file, vocab_size):
    train_file = train_file + '.' + \
        str(vocab_size) + '.id.words'
...
class TrainModel(object):
    ...
    def loadVocab(self, vocab_size, vocab_file):
    ...
    def loadTrainParams(self, train_file, batch_size, default_learning_rate, valid_freq, finetune_epoch, chunk_size=10000, vocab_size=10000, n_epochs=5):
    ...
    def validate(self, model, batch_size, num_batches):
        """
        Subclass should override this function.
        """
        raise NotImplementedError("Override this function.")

    def test(self, model, batch_size, num_batches):
        """
        Subclass should override this function.
        """
        raise NotImplementedError("Override this function.")
    ...
    def openFiles(self):
        self.train_f = open_train_files(self.train_file, vocab_size)
